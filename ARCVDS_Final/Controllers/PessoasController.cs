...
namespace ARCVDS_Final.Controllers
{
    public class PessoasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Pessoa_ID,Nome,data_Nascimento,Sexo,Morada,Codigo_Postal,Nacionalidade,Email,Foto,numeroTelefone,numeroTelemovel")] Pessoas pessoas, HttpPostedFileBase UploadFoto)
        {
